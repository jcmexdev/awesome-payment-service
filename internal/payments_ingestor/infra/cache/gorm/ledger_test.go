...
func setupTestDB(t *testing.T) (*gorm.DB, func()) {
	...
	if err := db.AutoMigrate(&domain2.Account{}, &domain2.LedgerEntry{}); err != nil {
...
func TestLedgerRepository_ProcessPayment_InsufficientBalance(t *testing.T) {
	...
	var count int64
	db.Model(&domain2.LedgerEntry{}).Where("reference_id = ?", refID).Count(&count)
	if count != 0 {
